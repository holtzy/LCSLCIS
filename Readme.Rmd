...
The LCSLCIS package provides a `show_connection` function that allows to visualize the relationship between these 2 lists. This graphical function requires the `tidyverse` and `ggrepel` packages.
```{r, warning=FALSE, message=FALSE}
library(tidyverse)
library(ggrepel)
...
<br>
Vincent Ranwez: [homepage](https://sites.google.com/site/ranwez/) | [vincent.ranwez@supagro.fr](mailto:vincent.ranwez@supagro.fr) | corresponding author  
<br>
Sèverine Bérard: [homepage](http://www.pages-perso-severine-berard.univ-montp2.fr) | [Severine.Berard@umontpellier.fr](mailto:Severine.Berard@umontpellier.fr)  
